        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Employees_FootballClubs_FootballClubId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecoveryWeeks = table.Column<int>(type: "int", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    FootballClubId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalLists", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MedicalLists_FootballClubs_FootballClubId",
                        column: x => x.FootballClubId,
                        principalTable: "FootballClubs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Schedules_FootballClubs_FootballClubId",
                        column: x => x.FootballClubId,
                        principalTable: "FootballClubs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MatchPrograms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MatchPrograms_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MatchPrograms_FootballClubs_FootballClubId",
                        column: x => x.FootballClubId,
                        principalTable: "FootballClubs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_FootballClubId",
                table: "Employees",
                column: "FootballClubId");

            migrationBuilder.CreateIndex(
                name: "IX_MatchPrograms_EmployeeId",
                table: "MatchPrograms",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_MatchPrograms_FootballClubId",
                table: "MatchPrograms",
                column: "FootballClubId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalLists_FootballClubId",
                table: "MedicalLists",
                column: "FootballClubId");

            migrationBuilder.CreateIndex(
                name: "IX_Schedules_FootballClubId",
                table: "Schedules",
                column: "FootballClubId");
        }
